...
import { commissionStatistics } from "../../../../redux/slices/commissionHistory";
...
const SuperAdminDashboard = () => {
  ...
  // console.log('storeConvertCommision',storeConvertCommision)
  // console.log('storeCashout',storeCashout)
  // console.log('storeCashin',storeCashin)
  // console.log('storeCommissionHistory',storeCommissionHistory)
...
console.log('fromthestaret', filteredCommissionsFromTheStart)
console.log('objects', objects)
// console.log('tester',item)
// console.log('debugTest', item.game_history_id.outcome)
...
console.log('debug', filteredCommisionForDrawOutcome)
...
.catch((error) => {
  ...
  // ---------------------------ADDS ALL COMMISSIONS TAKEN FROM THE ARENA TODAY--------------------------------------
  ...
  //---------------reduxData---------------------
    ...
    // ------------------------checker----------------------------
    // console.log(((storeUsers.me?.commision || 0) * 100) / 100)
  // ------------------------checker----------------------------
  ...
  useEffect(() => {
    ...
    dispatch(allCashIn());
    dispatch(commissionStatistics(auth.user.role.id));
  }, []);
