...
const LobbyAnnouncementPreview = () => {
  return (
      ...
      <MDBContainer fluid className="p-3 ga-container">
        <MDBContainer fluid className="px-0 ga-header">
          <span>
            ...
            &nbsp;&nbsp;Lobby Announcement Preview
          </span>
        </MDBContainer>
        <MDBContainer fluid className="px-0 ga-body">
          <MDBContainer
            fluid
            className="ga-preview-container-warning d-flex align-items-center my-3 py-3"
          >
            <div className="ga-preview-icon-warning me-3 h-100">
...
export default LobbyAnnouncementPreview;
