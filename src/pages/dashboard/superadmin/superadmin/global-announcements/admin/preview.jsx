...
const AdminAnnouncementPreview = () => {
  return (
      ...
      <MDBContainer fluid className="p-3 ga-container">
        <MDBContainer fluid className="px-0 ga-header">
          <span>
            ...
            &nbsp;&nbsp;Admin Announcement Previewasdasd
          </span>
        </MDBContainer>
        <MDBContainer fluid className="px-0 ga-body">
          <MDBContainer
            fluid
            className="ga-preview-container-success d-flex align-items-center my-3 py-3"
          >
            <div className="ga-preview-icon-success me-3 h-100">
...
export default AdminAnnouncementPreview;
