...
const AgentProfileModal = (item) => {
  ...
  const toggleShow = () => {
    if (!centredModal) {
      dispatch(findUserDetails(item.data.id));
    }
        ...
        <MDBModalDialog centered size="lg">
          <MDBModalContent className="coreq-modal-body py-2">
            ...
            <MDBModalBody>
              ...
              <p className="mb-4">{item.data.email}</p>
              <div className="d-flex justify-content-center mb-5">
                ...
                <div className="clt-assigned m-1">
                  <MDBIcon fas icon="user-alt" /> {item.data.role.name && item.data.role.name}
                </div>
              </div>
              ...
              <MDBContainer fluid className="p-3 variance-body w-50">
                ...
                <div className="variance-items">
                  <span>Referrer:</span>
                  <span>{item.data.referrer?.username}</span>
                </div>
                <div className="variance-items">
                  <span>Country:</span>
