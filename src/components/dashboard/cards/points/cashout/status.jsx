...
import { myCashoutRequest } from "../../../../../redux/slices/cashout";
  ...
  return (
    <MDBCol>
      ...
      >
        ...
        {/* <div className="text-end acs-filter">
          <MDBIcon
            fas
            icon="redo-alt"
            size="xl"
        ...
        <MDBContainer fluid className="px-0 acs-table-container h-100">
          <div className="table-responsive">
            <table className="acs-table h-100">
              ...
              <tbody>
                ...
                ) : storeCashout.myCashoutRequest.length ? (
                  storeCashout.myCashoutRequest?.map((item, i) => (
                    <tr className="text-center" key={i}>
                      ...
                      <td className="text-truncate">
                        <div
                          className={`acs-${item.status}-button d-flex align-items-center justify-content-center`}
                        >
                          &nbsp;{" "}
          ...
          >
            ...
            <button
              ...
              disabled={storeCashout.myCashoutRequest.length < itemsPerPage}
            >
